...
class LTTextContainer(LTExpandableContainer, LTText):
    ...
    def get_text(self):
        return ''.join(obj.get_text() for obj in self if
                       isinstance(obj, LTText))
...
class LTLayoutContainer(LTContainer):
    ...
    def group_textboxes(self, laparams, boxes):
        ...
        def dist(obj1, obj2):
            ...
            return ((x1-x0)*(y1-y0) - obj1.width*obj1.height -
    ...
    def analyze(self, laparams):
        ...
        (textobjs, otherobjs) = fsplit(lambda obj:
                                       isinstance(obj, LTChar), self)
