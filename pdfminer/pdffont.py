        ...
        if b0 == 30:
            ...
            if 247 <= b0 and b0 <= 250:
                ...
                if b0 == 28:
                    ...
                    value = b1 << 24 | b2 << 16 | struct.unpack('>H',
                                                                fp.read(2))[0]
        stack.append(value)
    return d
                ...
                for (ec, sc, idd, idr) in zip(ecs, scs, idds, idrs):
                    if idr:
                        ...
                        for c in range(sc, ec+1):
                            char2gid[c] = (struct.unpack('>H', fp.read(2))[0] +
                                           idd) & 0xffff
                    else:
                        for c in range(sc, ec+1):
...
class PDFFont:
    ...
    def __init__(self, descriptor, widths, default_width=None):
        ...
        self.default_width = default_width or \
            num_value(descriptor.get('MissingWidth', 0))
...
class PDFCIDFont(PDFFont):
    ...
    def __init__(self, rsrcmgr, spec):
        ...
        if 'ToUnicode' in spec:
            ...
            try:
                self.unicode_map = \
                    CMapDB.get_unicode_map(self.cidcoding,
    ...
    def __repr__(self):
        return '<PDFCIDFont: basefont=%r, cidcoding=%r>' % (self.basefont,
                                                            self.cidcoding)
