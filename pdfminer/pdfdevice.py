...
class PDFTextDevice(PDFDevice):
    ...
    def render_string(self, textstate, seq, graphicstate):
        ...
        if font.is_vertical():
            textstate.linematrix = self.render_string_vertical(
                ...
                scaling, charspace, wordspace, rise, dxscale, graphicstate)
        else:
    ...
    def render_string_horizontal(self, seq, matrix, pos,
                                 font, fontsize, scaling, charspace, wordspace, rise, dxscale, graphicstate):
        (x, y) = pos
        needcharspace = False
        for obj in seq:
            if utils.isnumber(obj):
                ...
                for cid in font.decode(obj):
                    ...
                    x += self.render_char(utils.translate_matrix(matrix, (x, y)),
                                          font, fontsize, scaling, rise, cid, graphicstate)
